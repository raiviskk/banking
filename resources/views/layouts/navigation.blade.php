...
{{--                </div>--}}
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('crypto.prices')" :active="request()->routeIs('crypto.prices')">
                        {{ __('Crypto') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('crypto.wallets')" :active="request()->routeIs('crypto.wallets')">
                        {{ __('Crypto Wallets') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('stock.prices')" :active="request()->routeIs('stock.prices')">
                        {{ __('Stock') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('stock.wallets')" :active="request()->routeIs('stock.wallets')">
                        {{ __('Stock Wallets') }}
                    </x-nav-link>
                </div>
